...
1. Beginning with version 2.12.x, Sourcegraph's Kubernetes deployment requires an Enterprise license key. See ["Add a license key"](./configure.md#add-a-license-key) for instructions.
