...
The type of the `frontend` service ([base/frontend/frontend.Service.yaml](../base/frontend/frontend.Service.yaml)) has changed
...
If you previously configured `TLS_KEY` and `TLS_CERT` environment variables, you can remove them from [base/frontend/frontend.Deployment.yaml](../base/frontend/frontend.Deployment.yaml)
